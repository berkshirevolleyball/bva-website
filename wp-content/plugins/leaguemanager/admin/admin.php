...
*/
	...
	{
		global $wpdb;
		$team = $wpdb->get_results( $wpdb->prepare("SELECT `league_id`, `title`, `website`, `coach`, `stadium`, `home`, `group`, `roster`, `logo`, `custom` FROM {$wpdb->leaguemanager_teams} WHERE `id` = '%d'", $team_id) );
		$team = $team[0];
